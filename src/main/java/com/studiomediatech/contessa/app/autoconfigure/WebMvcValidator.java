...
/**
 * A {@link SmartValidator} exposed as a bean for WebMvc use. Wraps existing {@link SpringValidatorAdapter} instances
 * so that only the Spring's {@link Validator} type is exposed. This prevents such a bean to expose both the Spring and
 * JSR-303 validator contract at the same time.
 *
