...
public class Hacked_WebMvcAutoConfiguration {
	...
	@Bean
	@ConditionalOnMissingBean(OrderedFormContentFilter.class)
...
//		}
	 ...
	 * @author Bruce Brouwer
	 */
	final static class WelcomePageHandlerMapping extends AbstractUrlHandlerMapping implements Loggable {
